...
// TODO: reemplaza con el origen donde publiques el dashboard (GitHub Pages o tu dominio propio)
...
export default {
  async fetch(request, env) {
    ...
    if (service === 'meta') {
      ...
      // la agencia (ej. cuando el System User vive en el Business Manager
      // del cliente en vez del de la agencia). Sin tokenKey, se usa
      // META_TOKEN por defecto — comportamiento sin cambios para todos los
